...
pub struct BiosAttributes {
    ...
    pub access_control_service: String,
    pub acpi_hpet: String,
    pub acpi_root_bridge_pxm: String,
    pub acpi_slit: String,
    pub adv_crash_dump_mode: String,
    pub allow_login_with_ilo: String,
    ...
    pub application_power_boost: String,
    pub asset_tag_protection: String,
    pub auto_power_on: String,
    pub boot_mode: String,
    pub boot_order_policy: String,
    pub c_state_efficiency_mode: String,
    pub collab_power_control: String,
    pub consistent_dev_naming: String,
    pub data_fabric_c_state_enable: String,
    pub daylight_savings_time: String,
    pub determinism_control: String,
    pub dhcpv4: String,
    pub dram_controller_power_down: String,
    pub dynamic_pcie_rate_change: String,
    pub dynamic_power_capping: String,
    pub emb_sata1_aspm: String,
    pub emb_sata1_enable: String,
    #[serde(rename = "EmbSata1PCIeOptionROM")]
    pub emb_sata1_pcie_option_rom: String,
    pub emb_video_connection: String,
    pub embedded_diagnostics: String,
    pub embedded_ipxe: String,
    pub embedded_serial_port: String,
    pub embedded_uefi_shell: String,
    pub ems_console: String,
    pub enabled_cores_per_proc: String,
    #[serde(rename = "EnhancedPreferredIOBusEnable")]
    pub enhanced_preferred_io_bus_enable: String,
    pub erase_user_defaults: YesNo,
    pub extended_ambient_temp: String,
    pub extended_mem_test: String,
    pub f11_boot_menu: String,
    #[serde(rename = "FCScanPolicy")]
    pub fc_scan_policy: String,
    pub fan_fail_policy: String,
    pub fan_install_req: String,
    pub hour_format: String,
    pub http_support: String,
    pub infinity_fabric_pstate: String,
    pub intelligent_provisioning: String,
    pub ipmi_watchdog_timer_action: String,
    pub ipmi_watchdog_timer_status: String,
    pub ipmi_watchdog_timer_timeout: String,
    pub ipv4_address: String,
    pub ipv4_gateway: String,
    #[serde(rename = "Ipv4PrimaryDNS")]
    pub ipv4_primary_dns: String,
    pub ipv4_subnet_mask: String,
    pub ipv6_address: String,
    pub ipv6_config_policy: String,
    pub ipv6_duid: String,
    pub ipv6_gateway: String,
    #[serde(rename = "Ipv6PrimaryDNS")]
    pub ipv6_primary_dns: String,
    pub ipxe_auto_start_script_location: String,
    pub ipxe_boot_order: String,
    pub ipxe_script_auto_start: String,
    pub ipxe_script_verification: String,
    pub ipxe_startup_url: String,
    pub kcs_enabled: Option<String>, // only available on newer uefi and bmc firmware
    #[serde(rename = "LastLevelCacheAsNUMANode")]
    pub last_level_cache_as_numa_node: String,
    #[serde(rename = "MaxMemBusFreqMHz")]
    pub max_mem_bus_freq_mhz: String,
    pub max_pcie_speed: String,
    pub maximum_sev_asid: String,
    pub mem_patrol_scrubbing: String,
    pub mem_refresh_rate: String,
    pub microsoft_secured_core_support: String,
    pub min_proc_idle_power: String,
    pub minimum_sev_asid: i64,
    pub mixed_power_supply_reporting: String,
    pub network_boot_retry: String,
    pub network_boot_retry_count: i64,
    pub no_execution_protection: String,
    pub numa_group_size_opt: String,
    pub numa_memory_domains_per_socket: String,
    pub nvme_option_rom: String,
    pub nvme_raid: String,
    pub ocp1_auxiliary_power: String,
    pub omit_boot_device_event: String,
    pub package_power_limit_control_mode: String,
    pub package_power_limit_value: i64,
    pub patrol_scrub_duration: i64,
    pub pci_resource_padding: String,
    pub performance_determinism: String,
    pub platform_certificate: String,
    #[serde(rename = "PlatformRASPolicy")]
    pub platform_ras_policy: String,
    pub post_asr: String,
    pub post_asr_delay: String,
    pub post_boot_progress: String,
    pub post_discovery_mode: String,
    pub post_f1_prompt: String,
    pub post_screen_mode: String,
    pub post_video_support: String,
    pub power_button: String,
    pub power_on_delay: String,
    pub power_regulator: String,
    pub pre_boot_network: String,
    pub preboot_network_env_policy: String,
    pub preboot_network_proxy: String,
    #[serde(rename = "PreferredIOBusEnable")]
    pub preferred_io_bus_enable: String,
    #[serde(rename = "PreferredIOBusNumber")]
    pub preferred_io_bus_number: i64,
    #[serde(rename = "ProcAMDBoost")]
    pub proc_amd_boost: String,
    #[serde(rename = "ProcAMDBoostControl")]
    pub proc_amd_boost_control: String,
    pub proc_aes: String,
    pub proc_amd_fmax: i64,
    pub proc_amd_io_vt: Option<String>,
    #[serde(rename = "ProcSMT")]
    pub proc_smt: String,
    pub proc_x2_apic: String,
    pub product_id: String,
    pub redundant_power_supply: String,
    pub removable_flash_boot_seq: String,
    pub restore_defaults: YesNo,
    pub restore_manufacturing_defaults: YesNo,
    pub rom_selection: String,
    pub sata_sanitize: String,
    pub sata_secure_erase: String,
    pub save_user_defaults: YesNo,
    pub sci_ras_support: String,
    pub sec_start_backup_image: String,
    ...
    pub server_asset_tag: String,
    pub server_config_lock_status: String,
    pub server_name: String,
    pub setup_browser_selection: String,
    pub speculative_lock_scheduling: String,
    pub sriov: String,
    pub thermal_config: String,
    pub thermal_shutdown: String,
    pub time_format: String,
    pub time_zone: String,
    #[serde(rename = "TPM2EndorsementDisable")]
    pub tpm2_endorsement_disable: String,
    #[serde(rename = "TPM2StorageDisable")]
    pub tpm2_storage_disable: String,
    pub tpm20_software_interface_operation: String,
    pub tpm20_software_interface_status: String,
    pub tpm2_operation: String,
    pub tpm_active_pcrs: String,
    pub tpm_chip_id: String,
    pub tpm_fips: String,
    pub tpm_fips_mode_switch: String,
    pub tpm_mode_switch_operation: String,
    pub tpm_state: String,
    pub tpm_type: String,
    pub tpm_uefi_oprom_measuring: String,
    pub tpm_visibility: String,
    pub transparent_secure_memory_encryption: String,
    pub uefi_optimized_boot: String,
    pub uefi_serial_debug_level: String,
    pub uefi_shell_boot_order: String,
    pub uefi_shell_physical_presence_keystroke: String,
    pub uefi_shell_script_verification: String,
    pub uefi_shell_startup: String,
    pub uefi_shell_startup_location: String,
    pub uefi_shell_startup_url: String,
    pub uefi_shell_startup_url_from_dhcp: String,
    pub uefi_variable_access_fw_control: String,
    pub usb_boot: String,
    pub usb_control: String,
    pub user_defaults_state: String,
    pub utility_lang: String,
    pub virtual_serial_port: String,
    pub vlan_control: String,
    pub vlan_id: i64,
    pub vlan_priority: i64,
    pub wake_on_lan: String,
    pub workload_profile: String,
    #[serde(rename = "XGMIForceLinkWidth")]
    pub xgmi_force_link_width: String,
    #[serde(rename = "XGMIMaxLinkWidth")]
    pub xgmi_max_link_width: String,
    #[serde(rename = "iSCSISoftwareInitiator")]
    pub iscsi_software_initiator: String,
}
